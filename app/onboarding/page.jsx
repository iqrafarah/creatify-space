...
import {uploadLinkedInPdf, parseLinkedInText} from "@/lib/linkedinService";

// Handles LinkedIn PDF upload and profile creation
export default function OnboardingPage() {
  ...
  // Handle LinkedIn PDF processing
  async function handleUpload() {
    ...
    try {
      ...
      const uploadRes = await uploadLinkedInPdf(file);
      ...
      const parseRes = await parseLinkedInText(text);
  ...
  return (
    <div className="py-6 min-h-screen flex flex-col items-center pb-4 h-screen overflow-scroll">
          ...
          <details className="group">
            ...
            <div className="p-4 border-t border-gray-200 text-sm text-gray-600">
              <ol className="pl-5 list-decimal">
                ...
                <li className="mb-2">
                  Click on "More" button below your profile header
                </li>
